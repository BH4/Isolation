...
#uses a cutoff for iterative deepening.
#Heuristic function weights positions that have more consecutive neighbors more highly.
#also uses a weighted bfs function for moves that do not pass the cutoff of iterative deepening.
